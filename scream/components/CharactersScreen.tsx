...
type Characters = {
  ...
  const characters:Characters[]=[
    {id: '1', director:'Director' ,description:'Character :Rose McGowan  ', cost:'Cost 1',stock:'Stock 1'},
    {id: '2',director:'Director' ,description:'Character : Drew Barrymore', cost:'Cost 2',stock:'Stock 2'},
    {id: '3', director:'Director',description:'Character : Skeet Ulrich', cost:'Cost 3',stock:'Stock 3'},
    {id: '4', director:'Director' ,description:'Character : Matthew Lillard ', cost:'Cost 1',stock:'Stock 1'},
    {id: '5',director:'Director' ,description:'Character: Sarah Michelle Gellar', cost:'Cost 2',stock:'Stock 2'},
